/**
 * Optel Explorer - List Facet Component
 * A custom HTML element to display a list of facets with checkboxes and CWV metrics.
 */
 ...
 * <optel-list-facet facet="userAgent" mode="all">
