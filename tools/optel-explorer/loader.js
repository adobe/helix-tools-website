/**
 * Optel Data Loader
 * This module handles all loading of Optel bundles from the API.
 * Ideally it would work offline, so it should be a service worker.
 * We will migrate code from the main file to here.
 */
